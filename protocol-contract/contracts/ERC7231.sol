...
contract ERC7231 is IERC7231,ERC721Upgradeable {
     ...
     */
    function __ERC7231_init(string memory _name,string memory _symbol) internal onlyInitializing  {
    ...
    function verifyIdentitiesBinding(
        uint256 id,address nftOwnerAddress,address sigAddress,string[] memory userIDs,bytes32 multiIdentitiesRoot, bytes calldata signature
        ...
        bool isVerified = SignatureChecker.isValidSignatureNow(sigAddress,multiIdentitiesRoot,signature);
        return isVerified;
